var fs = require('fs');
var input_filename = './data/raw/date-20160323-time-105609-42042-hotels.csv';
var output_filename = './data/master_hotel_records_map.json';
...
fs.writeFileSync(output_filename, JSON.stringify(mhid_map, null, 2));
// console.log(data[0]);
